...
class MoviesAdapter(val loadMore: () -> Unit, val onMovieSelection: (Int) -> Unit): ListAdapter<Movie, RecyclerView.ViewHolder>(
    ...
    class MovieViewHolder(val view: ItemMovieBinding, val onClick: (Int) -> Unit): RecyclerView.ViewHolder(view.root) {
        init {
